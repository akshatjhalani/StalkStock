...
/**
 * A dasboard-service created to interact with the backend server for user dasboard functionalities.
 */
export class DashboardService {
  ...
  public GET_STOCKS() {
    var data: Stock[] = [{'id': 'MSFT', 'name': 'Microsoft Corporation', 'img': 'https://logo.clearbit.com/microsoft.com'}, {'id': 'GS', 'name': 'Goldman Sachs Group, Inc. (The)', 'img': 'https://logo.clearbit.com/goldmansachs.com'}, {'id': 'V', 'name': 'Visa Inc.', 'img': 'https://logo.clearbit.com/usa.visa.com'}, {'id': 'AXP', 'name': 'American Express Company', 'img': 'https://logo.clearbit.com/americanexpress.com'}, {'id': 'AMGN', 'name': 'Amgen Inc.', 'img': 'https://logo.clearbit.com/amgen.com'}, {'id': 'CSCO', 'name': 'Cisco Systems, Inc.', 'img': 'https://logo.clearbit.com/cisco.com'}, {'id': 'KO', 'name': 'Coca-Cola Company (The)', 'img': 'https://logo.clearbit.com/coca-colacompany.com'}, {'id': 'DIS', 'name': 'Walt Disney Company (The)', 'img': 'https://logo.clearbit.com/thewaltdisneycompany.com'}, {'id': 'CVX', 'name': 'Chevron Corporation', 'img': 'https://logo.clearbit.com/chevron.com'}, {'id': 'DOW', 'name': 'Dow Inc.', 'img': 'https://logo.clearbit.com/dow.com'}, {'id': 'HON', 'name': 'Honeywell International Inc.', 'img': 'https://logo.clearbit.com/honeywell.com'}, {'id': 'WMT', 'name': 'Walmart Inc.', 'img': 'https://logo.clearbit.com/stock.walmart.com'}, {'id': 'WBA', 'name': 'Walgreens Boots Alliance, Inc.', 'img': 'https://logo.clearbit.com/walgreensbootsalliance.com'}, {'id': 'AAPL', 'name': 'Apple Inc.', 'img': 'https://logo.clearbit.com/apple.com'}, {'id': 'INTC', 'name': 'Intel Corporation', 'img': 'https://logo.clearbit.com/intel.com'}, {'id': 'HD', 'name': 'Home Depot, Inc. (The)', 'img': 'https://logo.clearbit.com/homedepot.com'}, {'id': 'CAT', 'name': 'Caterpillar, Inc.', 'img': 'https://logo.clearbit.com/caterpillar.com'}, {'id': 'NKE', 'name': 'Nike, Inc.', 'img': 'https://logo.clearbit.com/nike.com'}, {'id': 'BA', 'name': 'Boeing Company (The)', 'img': 'https://logo.clearbit.com/boeing.com'}, {'id': 'MRK', 'name': 'Merck & Company, Inc.', 'img': 'https://logo.clearbit.com/merck.com'}, {'id': 'MMM', 'name': '3M Company', 'img': 'https://logo.clearbit.com/3m.com'}, {'id': 'MCD', 'name': "McDonald's Corporation", 'img': 'https://logo.clearbit.com/corporate.mcdonalds.com'}, {'id': 'PG', 'name': 'Procter & Gamble Company (The)', 'img': 'https://logo.clearbit.com/pginvestor.com'}, {'id': 'VZ', 'name': 'Verizon Communications Inc.', 'img': 'https://logo.clearbit.com/verizon.com'}, {'id': 'IBM', 'name': 'International Business Machines', 'img': 'https://logo.clearbit.com/ibm.com'}, {'id': 'TRV', 'name': 'The Travelers Companies, Inc.', 'img': 'https://logo.clearbit.com/travelers.com'}, {'id': 'JPM', 'name': 'JP Morgan Chase & Co.', 'img': 'https://logo.clearbit.com/jpmorganchase.com'}, {'id': 'UNH', 'name': 'UnitedHealth Group Incorporated', 'img': 'https://logo.clearbit.com/unitedhealthgroup.com'}, {'id': 'JNJ', 'name': 'Johnson & Johnson', 'img': 'https://logo.clearbit.com/jnj.com'}, {'id': 'CRM', 'name': 'Salesforce.com Inc', 'img': 'https://logo.clearbit.com/salesforce.com'}];

    return of(data);
  }
  public GET_STOCK_DETAILS(stock:string) {
    const url = this.constants.PriceUrl + "price/" + stock.toUpperCase() ;
    return this.http.get(url);
  }

  public GET_STOCK_PREDICTION(stock:string) {
    const url = this.constants.PriceUrl + "predict/" + stock.toUpperCase() ;
    return this.http.get(url);
  }

  public GET_STOCK_DETAILS_1(stock:string) {
    const url = this.constants.PriceUrl + "price/" + stock.toUpperCase() ;
    var data = []
    if (stock == "S&P") {
      data = [
